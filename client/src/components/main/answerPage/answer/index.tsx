...
interface AnswerProps {
  ...
  aiAnswer?: boolean; // added AI answer prop
}
 ...
 * @param aiAnswer Flag indicating if the answer was generated by an AI.
 */
const AnswerView = ({ text, ansBy, meta, comments, handleAddComment, aiAnswer }: AnswerProps) => (
  <div className='answer right_padding'>
    {aiAnswer && <div className='ai-generated'>AI-Generated Answer:</div>}
    <div id='answerText' className='answerText'>
      {handleHyperlink(text)}
    </div>
    {!aiAnswer && ( // to leave out author info for AI-generated answers
